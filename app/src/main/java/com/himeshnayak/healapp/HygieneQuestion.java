...
public class HygieneQuestion extends AppCompatActivity {
    ...
    private String[] questions = {
            ...
            "Do I massage my body to improve circulation?",
            "Do I believe that purification of my body is important to remove TRIDOSH - VAAT, KAPH and PIT?",
            "Do I believe that physical cleaning has impacts on mental cleaning?",
            "Do I keep my environment neat and clean?",
            "Do I wash my feet and hands after coming from outside?"
    };

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hygiene_question);

        pageBefore = findViewById(R.id.page_before_questions);
        description = findViewById(R.id.hygiene_description);
        ...
        position = 0;
        marks = 0;
        questionView = findViewById(R.id.hygiene_questions_view);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(position == questions.length - 1)
                {
                    if(marks >= 8 && marks < 13)
                    {
                        description.setText(R.string.hygiene_ques_ans_1);
                    }
                    else if (marks >= 13 && marks < 18){
                        description.setText(R.string.hygiene_ques_ans_2);
                    }
                    else
                        description.setText(R.string.hygiene_ques_ans_3);
