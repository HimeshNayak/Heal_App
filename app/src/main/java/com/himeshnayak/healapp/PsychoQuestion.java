...
public class PsychoQuestion extends AppCompatActivity {
    ...
    private String[] questions = {
            ...
            "Am I able to control my emotional outbursts?",
            "Do I feel like withdrawing from my life?",
            "Do I feel guilty and worthless?",
            "Am I patient and tolerant?",
            "Do I feel more alive and engaged?"
    };

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_psycho_question);

        pageBefore = findViewById(R.id.page_before_questions);
        description = findViewById(R.id.psycho_description);
        ...
        position = 0;
        marks = 0;
        questionView = findViewById(R.id.psycho_questions_view);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(position == questions.length - 1)
                {
                    if(marks >= 8 && marks < 13)
                    {
                        description.setText(R.string.psycho_ques_ans_1);
                    }
                    else if (marks >= 13 && marks < 18){
                        description.setText(R.string.psycho_ques_ans_2);
                    }
                    else
                        description.setText(R.string.psycho_ques_ans_3);
